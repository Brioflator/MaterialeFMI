...
using User = GameStore.Models.ApplicationUser;
...
namespace GameStore.Controllers
{
    public class UsersController : Controller
    {
        ...
        public IActionResult Delete(string id)
        {
            ...
            var user = db.Users.Include("Categories.Items.Comments").Include("UserCategory").Include("Items.Commnents").Include("Comments").Where(u => u.Id == id).FirstOrDefault();
