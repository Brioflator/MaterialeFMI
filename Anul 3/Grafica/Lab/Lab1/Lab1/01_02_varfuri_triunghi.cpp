...
void CreateVBO(void)
{
    ...
    GLfloat Vertices[] = {
         -0.9f, 0.0f, 0.0f, 1.0f,  //stanga negru
         -0.4f, 0.2f, 0.0f, 1.0f,  // stanga sus rosu
         -0.9f, -0.8f, 0.0f, 1.0f, // stanga jos albastru
         -1.0f, -0.8f, 0.0f, 1.0f, // linie rosu 1
         -0.3f, 0.2f, 0.0f, 1.0f,  // linie rosu 2
         -0.1f, 0.3f, 0.0f, 1.0f,  // linie rosu 3
         -0.4f, -0.1f, 0.0f, 1.0f,  // linie mov 1
         -0.2f, 0.1f, 0.0f, 1.0f, // linie mov 2
         0.0f, 0.4f, 0.0f, 1.0f,  // linie roz 1
         -0.1f, 0.8f, 0.0f, 1.0f,  // linie roz 2
