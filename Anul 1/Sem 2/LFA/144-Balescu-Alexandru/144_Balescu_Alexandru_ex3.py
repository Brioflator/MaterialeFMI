...
# De asemenea, se va realiza o functie pentru a verifica daca cele 2 benzi sunt identice
...
def check_if_identical():  # O functie pentru a verifica daca cele 2 benzi sunt identice
    if mainTape == secondTape:
        print("The 2 tapes are identical")
    else:
        print("The 2 tapes are not identical")


if(valid == 2):
    # Functia de verificare este apelata inainte de cea pentru validarea unui cuvant
    check_if_identical()
    # Deoarece in validarea cuvantului, prima banda se modifica
    validate_word()
